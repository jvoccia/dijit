...
// Set dijit package location
dojoConfig.packages.push({ 'name': 'dijit',  'location' : testDir + '../../..'});
...
document.write('<script type="text/javascript" src="' + testDir + '../../../node_modules/dojo/dojo.js"></script>');
